import { LayoutDashboard, AlertCircle, CheckCircle2, UserPlus, ClipboardList, TrendingUp, Settings, Upload, BarChart2, RefreshCw, Calendar } from 'lucide-react';
...
export const navItems: NavItem[] = [
  ...
  { title: 'Agenda', url: '/agenda', icon: Calendar, showInBottomNav: true },
];
