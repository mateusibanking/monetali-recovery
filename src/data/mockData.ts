...
export const clients: Client[] = [
  ...
  { id: '3', nome: 'LIMPIDOZ HIGIENE INDUSTRIAL', cnpj: '', regional: 'RJ / SP', executivo: 'Matheus Castro', compensacao: 1727160.59, juros: 0, boletoVitbank: 1209012.42, pixMonetali: 81047.02, diasAtraso: 346, parcelas: 6, situacao: 'COBRANÇA EM ANDAMENTO', flags: [] },
  { id: '4', nome: 'LIMPIDOZ PRESTADORA', cnpj: '', regional: 'RJ / SP', executivo: 'Matheus Castro', compensacao: 1225179.17, juros: 14427.43, boletoVitbank: 843197.99, pixMonetali: 56814.52, diasAtraso: 425, parcelas: 8, situacao: 'COBRANÇA EM ANDAMENTO', flags: ['Prioridade'] },
  { id: '5', nome: 'SCARELI PAES CONGELADOS', cnpj: '06.986.218/0001-43', regional: 'MG', executivo: 'Gabriela Vilela', compensacao: 962227.18, juros: 0, boletoVitbank: 625447.67, pixMonetali: 45152.51, diasAtraso: 68, parcelas: 1, situacao: 'COBRANÇA EM ANDAMENTO', flags: [] },
  { id: '6', nome: 'KI BARATO LTDA', cnpj: '32.860.231/0001-61', regional: 'AL', executivo: 'Elias Soares', compensacao: 815922.48, juros: 8866.61, boletoVitbank: 521483.00, pixMonetali: 37871.09, diasAtraso: 128, parcelas: 4, situacao: 'COBRANÇA EM ANDAMENTO', flags: ['Juros'] },
  { id: '7', nome: 'DI CANALLI COMERCIO', cnpj: '03.591.919/0001-95', regional: 'RS / SC', executivo: 'Weslley Fernando', compensacao: 784946.17, juros: 7098.77, boletoVitbank: 504056.59, pixMonetali: 36500.48, diasAtraso: 219, parcelas: 3, situacao: 'COBRANÇA EM ANDAMENTO', flags: [] },
  { id: '8', nome: 'DICASA MATERIAIS', cnpj: '07.013.648/0001-41', regional: 'TO / PA', executivo: 'João Batista', compensacao: 663756.03, juros: 0, boletoVitbank: 497817.03, pixMonetali: 31146.75, diasAtraso: 83, parcelas: 3, situacao: 'COBRANÇA EM ANDAMENTO', flags: [] },
  { id: '9', nome: 'CENTRO HEMODIALISE', cnpj: '', regional: 'TO / PA', executivo: 'Joy Colares', compensacao: 654869.73, juros: 0, boletoVitbank: 491152.30, pixMonetali: 30729.77, diasAtraso: 100, parcelas: 4, situacao: 'COBRANÇA EM ANDAMENTO', flags: [] },
  ...
  { id: '11', nome: 'HJM GESTAO SERVICOS', cnpj: '26.478.473/0001-92', regional: 'RJ / SP', executivo: 'Felipe Soares', compensacao: 494506.28, juros: 318.95, boletoVitbank: 370560.76, pixMonetali: 23189.74, diasAtraso: 187, parcelas: 4, situacao: 'COBRANÇA EM ANDAMENTO', flags: [] },
  { id: '12', nome: 'ARTE FINAL COURO', cnpj: '', regional: 'MG', executivo: 'Carlos Barros', compensacao: 417811.21, juros: 0, boletoVitbank: 313358.42, pixMonetali: 19605.79, diasAtraso: 253, parcelas: 8, situacao: 'COBRANÇA EM ANDAMENTO', flags: [] },
